          ...
          <>
            ...
            <main className="container mx-auto px-4 py-8">
              <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-[#24044c]">Meus Produtos</h1>
                <Link
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Home</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Produtos</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Sobre nós</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Contato</Link></li>
        </ul>
      </div>
      <div>
        <h3 className="text-lg font-semibold mb-4">Ajuda</h3>
        <ul className="space-y-2">
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">FAQ</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Envio</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Devoluções</Link></li>
          <li><Link href="#" className="text-sm text-[#b681f8] hover:text-white">Pagamentos</Link></li>
        </ul>
      </div>
      <div>
        <h3 className="text-lg font-semibold mb-4">Newsletter</h3>
        <p className="text-sm text-[#b681f8] mb-2">Inscreva-se para receber ofertas exclusivas</p>
        <div className="flex">
          <input
            type="email"
